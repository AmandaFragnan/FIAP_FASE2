...
CREATE TABLE SENSOR (
    ...
    SEN_LOCALIZACAO VARCHAR2(100) NOT NULL     -- Localização do sensor na plantação (ex: área do campo)
);
...
CREATE TABLE LEITURA_SENSOR (
    ...
    LEI_VALOR NUMBER NOT NULL               -- Valor da leitura (FLOAT trocado para NUMBER)
);
...
CREATE TABLE AJUSTE_APLICACAO (
    ...
    AJU_QUANTIDADE_NUTRIENTES NUMBER NOT NULL -- Quantidade de nutrientes aplicados no ajuste (FLOAT trocado para NUMBER)
);
